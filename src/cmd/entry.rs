use crate::db;
use crate::util::{confirm, days_since, now_iso, open_db_with_migrate, STALE_THRESHOLD_DAYS};
...
pub fn cmd_purge(category: Option<&str>, source: Option<&str>, yes: bool) -> Result<(), Box<dyn std::error::Error>> {
